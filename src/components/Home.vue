<template>
  <div class="row justify-content-center">
    <article class="col-md-12">
      ...
      <header>
        <h2>Modern - Bootstrap 4 Cards</h2>
      </header>
      <!-- BLOG CARDS -->
      <h2>Blog Cards</h2>
              ...
              <div class="card card-blog">
                ...
                <div class="table">
                  ...
                  <p class="card-description">
                    ...
                    metus, pharetra vel nibh sit amet, tincidunt posuere nulla.
                    Vivamus odio antement, feugiat eget nisi sit amet,
              ...
              <div class="card">
                <div class="table table-info">
                  ...
                  <h4 class="card-caption">
                    <a href="#"
                      >"Vivamus odio ante, feugiat eget nisi sit amet, dignissim
                      velit. Sus pendisse ultricies varius."</a
                    >
                  </h4>
                  <div class="ftr">
                    <div class="author">
              ...
              <div class="card card-blog">
                ...
                <div class="table">
                  <h6 class="category text-success">
                    <i class="fa fa-university"></i> Law
                  </h6>
                  <h4 class="card-caption">
                    <a href="#"
                      >Vivamus odio ante, feugiat eget nisi sit amet, dignissim
                  ...
                  <p class="card-description">
                    Lorem ipsum dolor sit amet, consectetur adipis cingelit.
                    Etiam lacinia elit et placerat finibus.
                  </p>
                  <div class="ftr">
                    <div class="author">
                      <a href="#">
              ...
              <div class="card card-blog">
                ...
                <div class="table">
                  <h6 class="category text-warning">
                    <i class="fa fa-soundcloud"></i> Music
                  </h6>
                  <h4 class="card-caption">
                    <a href="#"
                      >Vivamus odio ante, feugiat eget nisi sit amet, dignissim
              ...
              <div class="card">
                <div class="table table-danger">
                  ...
                  <div class="ftr text-center">
                    <a href="#" class="btn btn-white btn-round">Read More</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card card-blog">
                ...
                <div class="table">
                  ...
                  <h4 class="card-caption">
                    <a href="#"
                      >Quisque id elit maximus, pretium diam at mollis elit</a
                    >
                  </h4>
                  <p class="card-description">
                    Lorem ipsum dolor sit amet, consectetur adipis cingelit.
            ...
            <div class="col-md-4">
              <div class="card card-blog">
                ...
                <div class="table">
                  <h6 class="category text-danger">Lacinia</h6>
                  <h4 class="card-caption">
                    <a href="#"
                      >Quisque id elit maximus, pretium diam at mollis elit</a
                    >
              ...
              <div class="card card-blog">
                <div class="card-image">
                  <a href="#">
                    <img
                      class="img img-raised"
                      src="https://www.imageupload.co.uk/images/2018/10/15/blog02.jpg"
                    />
                  </a>
                </div>
                <div class="table">
          ...
          <div class="row">
            <div class="col-md-6">
              <div
                ...
                style="
                  background-image: url('http://adamthemes.com/demo/code/cards/images/blog07.jpeg');
                "
              >
                <div class="table">
                  ...
                  <a href="#">
                    <h3 class="card-caption">
                      Vivamus odio ante, feugiat eget nisisit
                    </h3>
                  </a>
                  <p class="card-description">
                    Lorem ipsum dolor sit amet, consectetur adipis cingelit.
                    Etiam lacinia elit et placerat finibus. Praesent justo
                    metus, pharetra vel nibh sit amet, tincidunt posuere nulla.
                    Vivamus odio antement, feugiat eget, scelerisque dignissim
                    velit antement.
                  </p>
                  ...
                  <a href="#pablo" class="btn btn-warning btn-round">
                    <i class="fa fa-cogs"></i> Our Project
            ...
            <div class="col-md-6">
              ...
              >
                <div class="table">
                  <h6 class="category text-info">Category</h6>
                  <h3 class="card-caption">
                    Quisque id elit maximus, pretium mollis elit
                  </h3>
                  <p class="card-description">
                    Lorem ipsum dolor sit amet, consectetur adipis cingelit.
                    Etiam lacinia elit et placerat finibus. Praesent justo
                    metus, pharetra vel nibh sit amet, tincidunt posuere nulla.
                    Vivamus odio antement, feugiat eget amet, scelerisque velit
                    antement.
                  </p>
              ...
              <div class="card card-profile">
                ...
                <div class="table">
                  ...
                  <div class="ftr">
                    <a
                      href="#"
                      class="btn btn-just-icon btn-pinterest btn-round"
                      ><i class="fa fa-pinterest"></i>
                    </a>
                    <a href="#" class="btn btn-just-icon btn-twitter btn-round"
                      ><i class="fa fa-twitter"></i
                    ></a>
                    <a href="#" class="btn btn-just-icon btn-dribbble btn-round"
              ...
              <div class="card card-profile">
                ...
                <div class="table">
                  ...
                  <div class="ftr">
                    ...
                    <a
                      href="#"
                      class="btn btn-just-icon btn-simple btn-dribbble"
                      ><i class="fa fa-dribbble"></i
                    ></a>
                    <a
                      href="#"
                      class="btn btn-just-icon btn-simple btn-instagram"
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="table">
                  <h4 class="card-caption">John Smith</h4>
                  ...
                  <div class="ftr">
                    ...
                    ></a>
                    <a href="#" class="btn btn-just-icon btn-google btn-round"
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="table">
                  <h4 class="card-caption">Clementine Thson</h4>
                  <h6 class="category text-gray">Graphic Designer</h6>
                  <div class="ftr">
                    <a href="#" class="btn btn-just-icon btn-twitter btn-round"
                      ><i class="fa fa-twitter"></i
                    ></a>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="table">
                  <h4 class="card-caption">Elanor Aline</h4>
...
export default {
  data() {
    return {
      ...
      API_publicKey: "FLWPUBK-326e81a5ed73fedc3b0e43418ee11a15-X",
      phone: "759678174",
    };
  },
  methods: {
